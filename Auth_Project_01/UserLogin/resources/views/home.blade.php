...
<body>
    ...
    <nav class="navbar navbar-expand-lg " data-bs-theme="dark" >
        <div class="container-fluid ">
            <a href="" class="navbar-brand logo">VR2C </i></a>
    ...
    <!-- Section-4 -->
    <div class="form-title container" id="Booking">
    ...
    <section class="section-4 container">
        ...
        <form action="{{route('booking')}}" method="POST" id="form" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mt-3">
                        <Select class="form-control" name="tier">
                            <option value="Select Teir">Select Teir</option>
                            <option value="One Tier">One Tier</option>
                            <option value="Two Tier">Two Tier</option>
                            <option value="Three Tier">Three Tier</option>
                            <option value="Four Tier">Four Tier</option>
                        </Select>
                    </div>
                    <div class="col-md-4">
    ...
    <section class="end-sectiom container text-light ">
        ...
        <div class="link d-flex flex-column fw-semibold w-25 mx-auto p-5">
            ...
            <a href="/register" class="mt-3">New Registraion</a>
        </div>
